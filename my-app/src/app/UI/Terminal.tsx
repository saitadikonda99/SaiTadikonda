            ...
            return (
                <div className='About-me-command'>
                    <div className="About-me-command-in">
                        <h1>About Me</h1>
                        <p>
                            Tadikonda Sai Manikanta is a Full stack Developer and DevOps Engineer, where he drives innovation in cloud technologies and currently third year CS. undergrad.
                        </p>
                    </div>
                </div>
            )
            ...
            return (
                <div className='Skills-command'>
                    <div className="Skills-command-in">
                        <h1>Skills</h1>
                        <p> <span>• Languages:</span> Java, JavaScript, TypeScript, C, Go, Python</p>
                        <p> <span>• Frameworks:</span> Node, React, Next.js, Gorilla</p>
                        <p> <span>• Databases:</span> SQL, MongoDB</p>
                        <p> <span>• Tools:</span> Kubernetes, Docker, GIT</p>
                        <p> <span>• Platforms</span> AWS, Linux, Unix based systems</p>
                    </div>
                </div>
            )
        }
                ...
                <div className='Projects-command'>
                    <div className="Projects-command-in">
                        ...
                        <div className="projects-one">
                            <p>
                                <a href="https://github.com/saitadikonda99/Online-IDE">- Online IDE</a>
                            </p>
                            <p>
                                <a href="http://sac.kluniversity.in">- SAC Website</a>
                            </p>
                            <p>
                                <a href="https://github.com/saitadikonda99/JWT-Authentication">- JWT Authentication using Node.js and React</a>
                            </p>
                            <p>
                                <a href="https://github.com/saitadikonda99/Sri">- Temple Website</a>
                            </p>
                            <p>
                                <a href="">- Portfolio</a>
                            </p>
                            <p>
                                <a href=" https://github.com/saitadikonda99/ZeroOne-Website">- Online Coding Learning Platform</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            return (
                <div className='Contact-command'>
                    <div className="Contact-command-in">
                        <h1>Contact</h1>
                        <p>Phone: <span>+91 9703177577</span></p>
                        <p><FaLinkedin className='linkedin-icon' /> <a href="https://www.linkedin.com/in/tadikondasaimanikanta/">LikedIn</a> </p>
                        <p><FaGithub className='github-icon' /> <a href="https://github.com/saitadikonda99">GitHub</a> </p>
                        <p>Email: <a href="mailto:saitadikonda.cse@gmail.com">saitadikonda.cse@gmail.com</a></p>
                    </div>
                </div>
            )
        }
