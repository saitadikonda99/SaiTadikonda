        ...
        <div className="Skill">
            <div className="Skill-in">
                <div className="Skill-one">
                    ...
                    {props.tech === "html" && <FaHtml5 className='skill-icon-html skill-icon' />}
                    {props.tech === "css" && <FaCss3 className='skill-icon-css skill-icon' />}
                    {props.tech === "javascript" && <IoLogoJavascript className='skill-icon-javascript skill-icon' />}
                    {props.tech === "java" && <FaJava className='skill-icon-java skill-icon' />}
                    {props.tech === "typescript" && <SiTypescript className='skill-icon-typescript skill-icon' />}
                    {props.tech === "docker" && <FaDocker className='skill-icon-docker skill-icon' />}
                    {props.tech === "kubernetes" && <SiKubernetes className='skill-icon-kubernetes skill-icon' />}
                    {props.tech === "aws" && <FaAws className='skill-icon-aws skill-icon' />}
                    {props.tech === "golang" && <FaGolang className='skill-icon-golang skill-icon' />}
                    {props.tech === "git" && <FaGitAlt className='skill-icon-git skill-icon' />}
                    {props.tech === "c" && <TbLetterC className='skill-icon-c skill-icon' />}
                    {props.tech === "python" && <FaPython className='skill-icon-python skill-icon' />}
